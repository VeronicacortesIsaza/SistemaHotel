...
class Reserva(Base):
    ...
    usuario_crea = relationship("Usuario", foreign_keys=[id_usuario_crea], back_populates="reservas_creadas")
    usuario_edita = relationship("Usuario", foreign_keys=[id_usuario_edita], back_populates="reservas_editadas")

    def __repr__(self):
        return (f"<Reserva(id={self.id_reserva}, usuario={self.id_usuario}, "
